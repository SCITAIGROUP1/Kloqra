...
import { SupportTicketForm } from "@kloqra/web-shared";
import { getApiBase } from "@kloqra/web-shared";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2 md:grid md:grid-cols-5">
        {SLA_SUMMARY.map((s) => (
          <div key={s.label} className="flex-1 min-w-[120px] flex flex-col items-center gap-1 p-3 rounded-xl border bg-muted/30 text-center">
            {s.icon}
