...
const getStorageKey = (workspaceId: string) => `kloqra-widget-layout-${workspaceId}`;
const getDefaultStorageKey = (workspaceId: string) => `kloqra-widget-layout-default-${workspaceId}`;
