    ...
    <div className="pt-32 pb-24 min-h-screen">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start mb-16">
          ...
          <div>
            ...
            <p className="text-xl text-muted-foreground">
              Staff members logging their time. Their experience is intentionally simplified to stay out of the way of their real work.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-8">
            <section>
              <h3 className="text-2xl font-bold mb-6 border-b border-border pb-4">Privacy is paramount</h3>
              <p className="text-muted-foreground mb-4">Members are protected by strict privacy defaults. They CANNOT:</p>
              <ul className="space-y-4">
                {[
        ...
        <div className="mb-16">
          <h3 className="text-2xl font-bold mb-6 border-b border-border pb-4">The Member Experience</h3>
          <div className="flex flex-col md:flex-row gap-12 items-center bg-card/30 p-8 rounded-3xl border border-border/50">
            <div className="flex-1">
              ...
              <ul className="space-y-4 text-muted-foreground">
                <li className="flex gap-3"><CheckCircle2 className="text-primary w-5 h-5 shrink-0" /> Press Space to start · Space to stop</li>
                <li className="flex gap-3"><CheckCircle2 className="text-primary w-5 h-5 shrink-0" /> One active timer per session</li>
                <li className="flex gap-3"><CheckCircle2 className="text-primary w-5 h-5 shrink-0" /> Pause and resume without losing time</li>
              </ul>
            </div>
