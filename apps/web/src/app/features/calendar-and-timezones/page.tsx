      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="text-center mb-24">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Built for distributed teams. Visualize your week with intuitive drag-and-drop, while we
            handle the complex global timezone conversions behind the scenes.
          </p>
        </div>
        ...
        <div className="space-y-32">
          ...
          <section className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Ditch the spreadsheets. Our Day, Week, and Month views let you drag, drop, and
                stretch time blocks visually.
              </p>
          ...
          <section className="flex flex-col md:flex-row-reverse items-center gap-12">
            <div className="flex-1">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                When an engineer in Tokyo logs time, a manager in New York sees it correctly in
                their own local time. We handle the UTC conversions silently.
              </p>
          ...
          <section className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Set up intelligent nudges. Kloqra automatically pings members who haven't logged
                their minimum hours or submitted their weekly sheet.
              </p>
            </div>
              ...
              <div className="glass-card p-6 rounded-2xl border border-border/50 bg-background flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <span className="px-2 py-1 bg-[#E01E5A]/10 text-[#E01E5A] rounded text-[10px] font-bold uppercase">
                      Sent via Slack
                    </span>
                  </div>
                </div>
